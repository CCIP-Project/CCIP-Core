Contributing to CCIP Core
============================

The CCIP Core project operates an open contributor model where anyone is
...
The following applies to code changes to the CCIP Core project, and is not to be
confused with overall CCIP Network Protocol consensus changes.

Whether a pull request is merged into CCIP Core rests with the project merge
...
Patches that change CCIP consensus rules are considerably more involved than
...
Where a patch set proposes to change the CCIP consensus, it must have been
...
The project leader is the release manager for each CCIP Core release.
