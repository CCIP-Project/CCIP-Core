/* src/config/ccip-config.h.  Generated from ccip-config.h.in by configure.  */
/* src/config/ccip-config.h.in.  Generated from configure.ac by autoheader.  */

#ifndef CCIP_CONFIG_H

#define CCIP_CONFIG_H
...
#define PACKAGE_BUGREPORT "github.com/CCIP-Project/CCIP-Core"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Ccip Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Ccip Core 0.0.1"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "ccip"
