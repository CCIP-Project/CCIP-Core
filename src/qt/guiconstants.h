...
/* Ccip GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "CCIP"
#define QAPP_ORG_DOMAIN "ccipcoin.com"
#define QAPP_APP_NAME_DEFAULT "CCIP-Qt"
#define QAPP_APP_NAME_TESTNET "CCIP-Qt-testnet"
