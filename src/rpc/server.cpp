...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* CCIP features */
        {"ccip", "masternode", &masternode, true, true, false},
        {"ccip", "listmasternodes", &listmasternodes, true, true, false},
        {"ccip", "getmasternodecount", &getmasternodecount, true, true, false},
        {"ccip", "masternodeconnect", &masternodeconnect, true, true, false},
        {"ccip", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"ccip", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"ccip", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"ccip", "masternodecurrent", &masternodecurrent, true, true, false},
        {"ccip", "masternodedebug", &masternodedebug, true, true, false},
        {"ccip", "startmasternode", &startmasternode, true, true, false},
        {"ccip", "createmasternodekey", &createmasternodekey, true, true, false},
        {"ccip", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"ccip", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"ccip", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"ccip", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"ccip", "getmasternodescores", &getmasternodescores, true, true, false},
        {"ccip", "mnbudget", &mnbudget, true, true, false},
        {"ccip", "preparebudget", &preparebudget, true, true, false},
        {"ccip", "submitbudget", &submitbudget, true, true, false},
        {"ccip", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"ccip", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"ccip", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"ccip", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"ccip", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"ccip", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"ccip", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"ccip", "checkbudgets", &checkbudgets, true, true, false},
        {"ccip", "mnsync", &mnsync, true, true, false},
        {"ccip", "spork", &spork, true, true, false},
        {"ccip", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> ccip-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:51813/\n";
}
